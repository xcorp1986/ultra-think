...
class View
{
    ...
    public function parseTemplate($template = '')
    {
        ...
        if (C('TMPL_LOAD_DEFAULTTHEME') && THEME_NAME != C('DEFAULT_THEME')
            && !is_file($file)) {
            // 找不到当前主题模板的时候定位默认主题中的模板
            $file = dirname(THEME_PATH).'/'.C('DEFAULT_THEME').'/'.$template.C(
    ...
    protected function getThemePath($module = MODULE_NAME)
    {
        ...
        if (!$tmplPath) {
            ...
            $tmplPath = defined('TMPL_PATH') ? TMPL_PATH.$module.'/'
                : APP_PATH.$module.'/'.C('DEFAULT_V_LAYER').'/';
        }
